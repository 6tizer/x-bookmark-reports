...
export const mockSettings: Settings = {
  ...
  articlesDir: "/Users/<user>/work/Cursor/Twitter Bookmark/x-bookmark-reports/output/article-final",
  dataPath: "/Users/<user>/work/Cursor/Twitter Bookmark/x-bookmark-reports/data",

...
const navItems: NavItem[] = [
  ...
  { href: "/bookmarks", label: "Bookmarks", icon: <Bookmark size={18} />, badge: 201 },
  { href: "/sync", label: "Sync", icon: <RefreshCw size={18} /> },
  { href: "/reports", label: "Reports", icon: <FileText size={18} />, badge: 67 },
  { href: "/articles", label: "Articles", icon: <Newspaper size={18} /> },
